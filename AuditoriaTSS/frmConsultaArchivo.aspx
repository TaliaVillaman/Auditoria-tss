...
<body>
 ...
 <asp:PostBackTrigger  ControlID="btncargar"  />
        ...
        <asp:PostBackTrigger  ControlID="cknucleo"  />
        <asp:PostBackTrigger  ControlID="ckNss"  />
        <asp:PostBackTrigger  ControlID="ckpol"  />
        <asp:PostBackTrigger  ControlID="ckrad"  />
 </Triggers>
 <ContentTemplate>
       <div  class="portada" > 
         ...
         <div style="margin-left: 740px;">
          <asp:FileUpload ID="myFile" runat="server" Width="350px"  />
      ...
      ValidationExpression="^(([a-zA-Z]:)|(\\{2}\w+)\$?)(\\(\w[\w].*))(.xls|.xlsx)$">
             ...
             <div style="float: left;width:700px;height: 600px; overflow: scroll">
        ...
        <div style="float: left;width:100px;">
                             ...
                             <table style="float: left;margin-left:40px;width:400px;">
                                 ...
                                 <tr>
                                    ...
                                    <tr>
                                     <td>
                                            <asp:CheckBox ID="cknucleo" ValidationGroup="ckgroup" runat="server" AutoPostBack="true" OnCheckedChanged="cknucleo_CheckedChanged" /> <strong> Nucleo </strong>
                                     </td>
                                     </tr>

                                    <tr>
                                     <td>
                                            <asp:CheckBox ID="ckNss" ValidationGroup="ckgroup" runat="server" AutoPostBack="true" OnCheckedChanged="ckNss_CheckedChanged" /> <strong>Nss Individual </strong>
                                     </td>
                                  ...
                                  <tr>
                                     <td>
                                            <asp:CheckBox ID="ckpol" ValidationGroup="ckgroup" runat="server" AutoPostBack="true" OnCheckedChanged="ckpol_CheckedChanged" /> <strong>Póliza </strong>
                                     </td>
                                 ...
                                 <tr>
                                     <td>
                                            <asp:CheckBox ID="ckrad" ValidationGroup="ckgroup" runat="server" AutoPostBack="true" OnCheckedChanged="ckrad_CheckedChanged" /> <strong>Radicación </strong>
                                     </td>
