<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FrmConsultaCliente.aspx.cs" Inherits="AuditoriaTSS.FrmConsultaCliente" %>
...
<meta http-equiv="X-UA-Compatible" content="IE=9; IE=10" />
    <meta charset="utf-8"/>
  <title>Proceso Por Póliza</title>
...
<Triggers>
      ...
      <asp:PostBackTrigger  ControlID="btnmarcar"  />
        ...
        <asp:PostBackTrigger  ControlID="ckradicacion"  />
        <asp:PostBackTrigger  ControlID="ckpoliza"  />
     <asp:PostBackTrigger  ControlID="cknss"  />
 </Triggers>
 <ContentTemplate>
        <div  class="portada" >
    ...
    <div style="float:left;">
         ...
         <div style="float: left;margin-left: 740px;margin-top:-30px;">
      ...
      ValidationExpression="^(([a-zA-Z]:)|(\\{2}\w+)\$?)(\\(\w[\w].*))(.xls|.xlsx)$">
        ...
        <asp:GridView ID="Gvaudit"   runat="server" Width="100%" AutoGenerateColumns="False" 
                        ...
                        <Columns>
                         <asp:TemplateField HeaderStyle-BackColor="#0063ab" HeaderText="Marcar" Visible="true">
                                <ItemTemplate>
        ...
        <div style="float: left;width:100px;">
                             ...
                             <table style="float: left;margin-left:40px;width:400px;">
                                 ...
                                 <tr>
                                     <td>
                                         <strong style="color:#0063ab">Seleccione el tipo de busqueda :</strong>
                                     </td>
                                 </tr>
                                    <tr>
                                     <td>
                                            <asp:CheckBox ID="ckradicacion" ValidationGroup="ckgroup" runat="server" AutoPostBack="true" OnCheckedChanged="ckradicacion_CheckedChanged" /> <strong> Radicación </strong>
                                     </td>
                                     </tr>

                                       <tr>
                                     <td>
                                            <asp:CheckBox ID="ckpoliza" ValidationGroup="ckgroup" runat="server" AutoPostBack="true" OnCheckedChanged="ckpoliza_CheckedChanged" /> <strong>Póliza </strong>
                                     </td>
                                  ...
                                  <tr>
                                     <td>
                                            <asp:CheckBox ID="CKNSS" ValidationGroup="ckgroup" runat="server" AutoPostBack="true" Visible="false" OnCheckedChanged="CKNSS_CheckedChanged" /> <strong></strong>
                                     </td>
         ...
         <table >
             ...
             <tr>
                 <td>
                    <asp:Button ID="btncargar" CssClass="btn btn-primary btn-block" width="180px" runat="server" Text="Procesar" OnClick="btncargar_Click" OnClientClick="javascript:showWait();"   />
                 </td>
                  <td>
                      <asp:Button ID="btnRegresar" style="margin-left:5px;" CssClass="btn btn-primary btn-block" width="180px"   runat="server" Text="Regresar" OnClick="btnRegresar_Click"  />
                 </td>
             </tr>
         </table>
     ...
     <asp:UpdateProgress ID="UpdateProgress1" runat="server" DisplayAfter="0" AssociatedUpdatePanelID="UpdatePanel1" dynamiclayout="true">
        <ProgressTemplate>
         ...
         <div class="footer_cliente" style="float:left;">
          </div>
